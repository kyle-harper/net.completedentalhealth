<div class="container">
		<nav>
			...
			<div id="simple-menu" style="float:left;display:inline;"><a href="<?= $urlRoot; ?>sitemap.html"><img src="<?= $urlRoot; ?>images/nav-icon.png" alt="menu"/></a></div>
			<div id="call" class="call-button" style="float:right"><a href="tel:+16192952202"><img src="<?= $urlRoot; ?>images/call-icon.png" alt="call"/></a></div>
			<div id="map" style="float:right;display:inline;"><a target="_blank" href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3355.701990673899!2d-117.16529999999997!3d32.74710300000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d954d1ae36958f%3A0x4e292fc27ffed3ab!2sComplete+Dental+Health!5e0!3m2!1sen!2sus!4v1401558706996"><img src="<?= $urlRoot; ?>images/map-icon.png" alt="map"/></a></div>
			<ul>
...
<div class="container" style="position:relative;top:42px;">
